...
// import { DevicesService } from 'src/app/devices.service.js';
...
export class TemperatureComponent implements OnInit {
  ...
  //   });
    ...
    var chart1 = new CanvasJS.Chart("chartContainer", {
      ...
      title:{
        text:"temperature(celcius) Solar Cleaner 1",
        fontSize: 15
      },
      axisX:{
        title: "time",
    ...
    var chart2 = new CanvasJS.Chart("chartContainer2", {
      animationEnabled: true,  
      title:{
        text:"temperature(celcius) Solar Cleaner 2",
        fontSize: 15
      },
      axisX:{
        title: "time",
    ...
    var chart3 = new CanvasJS.Chart("chartContainer3", {
      animationEnabled: true,  
      title:{
        text:"temperature(celcius) Solar Cleaner 3",
        fontSize: 15
      },
      axisX:{
        title: "time",
    ...
    var chart4 = new CanvasJS.Chart("chartContainer4", {
      animationEnabled: true,  
      title:{
        text: "temperature(celcius) Solar Cleaner 4",
        fontSize: 15
      },
      axisX:{
        title: "time",
